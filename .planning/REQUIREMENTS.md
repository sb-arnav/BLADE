...
- [x] **WIRE2-01
**: Every NOT-WIRED backend module from WIRING-AUDIT.md has a UI surface added in Phase 14 (route / dashboard card / Settings tab / command-palette entry) OR an explicit "deferred to v1.2" rationale logged in the audit
- [x] **WIRE2-02
