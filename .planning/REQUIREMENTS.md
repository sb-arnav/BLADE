...
| REWARD-05 | 23 | partial — all 3 OOD modules authored: `adversarial_eval.rs` (Plan 23-03) + `ambiguous_intent_eval.rs` (Plan 23-04) + `capability_gap_stress_eval.rs` (Plan 23-05); `mod` registration pending (Plan 23-06) |
