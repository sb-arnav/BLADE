...
function ValenceArousalGrid({ valence, arousal, emotion }: { valence: number; arousal: number; emotion: EmotionName }) {
  ...
  return (
    <div className="flex flex-col gap-1">
      <div className="flex items-center justify-between text-2xs text-[rgba(255,255,255,0.3)] font-mono">
        <span>negative</span>
      ...
      <div className="relative border border-[rgba(255,255,255,0.1)] bg-[#09090b]/80 rounded" style={{ height: 120 }}>
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute left-0 right-0 top-1/2 border-t border-[rgba(255,255,255,0.07)]" />
        </div>
        {/* Quadrant labels */}
        <span className="absolute top-1 left-1.5 text-2xs text-[rgba(255,255,255,0.2)] font-mono leading-none">tense</span>
        <span className="absolute top-1 right-1.5 text-2xs text-[rgba(255,255,255,0.2)] font-mono leading-none">excited</span>
        <span className="absolute bottom-1 left-1.5 text-2xs text-[rgba(255,255,255,0.2)] font-mono leading-none">sad</span>
        <span className="absolute bottom-1 right-1.5 text-2xs text-[rgba(255,255,255,0.2)] font-mono leading-none">calm</span>
        {/* Dot */}
        <div
        ...
        />
        {/* Arousal labels */}
        <span className="absolute top-1 left-1/2 -translate-x-1/2 text-2xs text-[rgba(255,255,255,0.2)] font-mono leading-none">
          high
        </span>
        <span className="absolute bottom-1 left-1/2 -translate-x-1/2 text-2xs text-[rgba(255,255,255,0.2)] font-mono leading-none">
          low
        </span>
      </div>
      <div className="text-right text-2xs text-[rgba(255,255,255,0.3)] font-mono">arousal</div>
    </div>
  );
}
...
function EmotionTimeline({ readings }: { readings: EmotionReading[] }) {
  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="flex items-center justify-between text-2xs text-[rgba(255,255,255,0.2)] font-mono">
        <span>older</span>
        <span>recent →</span>
      </div>
    </div>
    ...
    <div className="flex flex-col h-full bg-black text-[rgba(255,255,255,0.85)] overflow-hidden">
      ...
      <div className="flex items-center justify-between px-4 py-3 border-b border-[rgba(255,255,255,0.1)] shrink-0">
        <div className="flex items-center gap-3">
          <button
            onClick={onBack}
            className="text-2xs text-[rgba(255,255,255,0.4)] hover:text-green-400 transition-colors font-mono"
          >
            ← back
          </button>
          ...
          <span className="text-2xs text-[rgba(255,255,255,0.3)] font-mono">emotional awareness</span>
        </div>
      </div>
        ...
        <div className="max-w-3xl mx-auto px-4 py-4 flex flex-col gap-6">
          ...
          <section>
            <div className="flex items-center gap-2 mb-3">
              ...
              {currentState?.detected_at && (
                <span className="text-2xs text-[rgba(255,255,255,0.3)] font-mono">
            ...
            <div className="border border-[rgba(255,255,255,0.1)] bg-[#09090b]/50 rounded p-4 flex flex-col gap-4">
              {currentState ? (
                <>
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div className="flex flex-col gap-1">
                      <div className="flex items-center gap-2">
                        <span className="text-2xs text-[rgba(255,255,255,0.4)] w-20">confidence</span>
                        ...
                        <span className="text-2xs text-[rgba(255,255,255,0.4)]">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="flex flex-col justify-center gap-2">
                      <div className="flex items-center gap-2">
                        <span className="text-2xs text-[rgba(255,255,255,0.4)] w-14">valence</span>
                        <div className="flex-1 h-1.5 bg-[rgba(255,255,255,0.04)] rounded-full overflow-hidden relative">
                          {/* Center marker */}
                          <div className="absolute top-0 bottom-0 left-1/2 w-px bg-[rgba(255,255,255,0.04)]" />
                        ...
                        <span className="text-2xs text-[rgba(255,255,255,0.4)] w-10 text-right">
                          {currentState.valence.toFixed(2)}
                        </span>
                      </div>
                      <div className="flex items-center gap-2">
                        <span className="text-2xs text-[rgba(255,255,255,0.4)] w-14">arousal</span>
                  ...
                  {currentState.signals && currentState.signals.length > 0 && (
                    <div className="flex flex-col gap-1.5">
                      <span className="text-2xs text-[rgba(255,255,255,0.4)] font-mono">detected via</span>
                      <div className="flex flex-wrap gap-1.5">
                        {currentState.signals.map((signal, i) => (
                          <span
                            key={i}
                            className="text-2xs px-1.5 py-0.5 rounded bg-[rgba(255,255,255,0.04)] text-[rgba(255,255,255,0.7)] border border-[rgba(255,255,255,0.1)] font-mono"
                          >
                            {signal}
                          </span>
                        ))}
                ...
                <div className="text-center py-4">
                  <p className="text-xs text-[rgba(255,255,255,0.3)] font-mono">No emotion data yet</p>
                  <p className="text-2xs text-[rgba(255,255,255,0.2)] mt-1">
                ...
                <>
                  ...
                  <div className="flex flex-col gap-1.5">
                    <div className="flex items-center justify-between">
                      <span className="text-2xs text-[rgba(255,255,255,0.4)]">avg valence</span>
                  ...
                  {/* Dominant emotion */}
                  <div className="flex items-center gap-2">
                    <span className="text-2xs text-[rgba(255,255,255,0.4)]">dominant</span>
                    <span
                    ...
                    <span className="text-2xs text-[rgba(255,255,255,0.3)]">{trend.reading_count} readings</span>
                  </div>

                  {/* Notable shifts */}
                  {trend.notable_shifts && trend.notable_shifts.length > 0 && (
                    <div className="flex flex-col gap-1.5">
                      <span className="text-2xs text-[rgba(255,255,255,0.4)] font-mono">notable shifts</span>
                      <div className="flex flex-col gap-1">
                        {trend.notable_shifts.map((shift, i) => (
                          <div key={i} className="flex items-center gap-1.5 text-2xs font-mono">
                            ...
                            <span className="text-[rgba(255,255,255,0.3)] ml-auto">{formatTimestamp(shift.at)}</span>
                          </div>
                        ))}
                      </div>
                    </div>
                  ...
                  {/* Emotion timeline */}
                  <div className="flex flex-col gap-1.5">
                    <span className="text-2xs text-[rgba(255,255,255,0.4)] font-mono">recent readings</span>
                    <EmotionTimeline readings={readings} />
                  </div>
                </>
              ) : (
                <div className="text-center py-4">
                  <p className="text-xs text-[rgba(255,255,255,0.3)] font-mono">No trend data for this period</p>
                </div>
              )}
            </div>
          </section>
          ...
          <section>
            ...
            <div className="border border-[rgba(255,255,255,0.1)] bg-[#09090b]/40 rounded p-4 flex flex-col gap-4">
              ...
              {patternAnalysis && (
                <div className="bg-black border border-[rgba(255,255,255,0.07)] rounded p-3">
                  <p className="text-xs text-[rgba(255,255,255,0.7)] leading-relaxed whitespace-pre-wrap font-mono">
                    {patternAnalysis}
                  </p>
                </div>
              )}
          ...
          <section>
            <div className="flex items-center gap-2 mb-3">
              ...
              <div className="flex-1 h-px bg-[rgba(255,255,255,0.04)]" />
              <span className="text-2xs text-[rgba(255,255,255,0.3)]">{readings.length} records</span>
            </div>

            {readings.length === 0 ? (
              <div className="border border-[rgba(255,255,255,0.07)] rounded p-6 text-center">
                <p className="text-xs text-[rgba(255,255,255,0.3)] font-mono">No readings yet</p>
              </div>
            ) : (
                ...
                <table className="w-full text-2xs font-mono">
                  <thead>
                    <tr className="border-b border-[rgba(255,255,255,0.1)] bg-[#09090b]">
                      ...
                      <th className="text-left px-3 py-2 text-[rgba(255,255,255,0.4)] font-normal w-20">arousal</th>
                      <th className="text-left px-3 py-2 text-[rgba(255,255,255,0.4)] font-normal w-16">conf</th>
                      <th className="text-left px-3 py-2 text-[rgba(255,255,255,0.4)] font-normal">signals</th>
                    </tr>
                  </thead>
                  <tbody>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-3 py-1.5">
                            <div className="flex items-center gap-1">
                              <div className="w-14 h-1.5 bg-[rgba(255,255,255,0.04)] rounded-full overflow-hidden relative">
                                <div className="absolute top-0 bottom-0 left-1/2 w-px bg-[rgba(255,255,255,0.07)]" />
                                {r.valence >= 0 ? (
                                  <div
                              ...
                              <span className="text-[rgba(255,255,255,0.3)] text-2xs">{r.valence.toFixed(2)}</span>
                            </div>
                          </td>
                          <td className="px-3 py-1.5">
                            <div className="flex items-center gap-1">
                              <div className="w-14 h-1.5 bg-[rgba(255,255,255,0.04)] rounded-full overflow-hidden">
                                <div
                                  className="h-full bg-amber-500"
                                  style={{ width: `${r.arousal * 100}%` }}
                                />
                              </div>
                              <span className="text-[rgba(255,255,255,0.3)] text-2xs">{r.arousal.toFixed(2)}</span>
                            </div>
                          </td>
                          <td className="px-3 py-1.5 text-[rgba(255,255,255,0.4)]">{Math.round(r.confidence * 100)}%</td>
                          <td className="px-3 py-1.5">
                            <div className="flex flex-wrap gap-1">
                              {(r.signals ?? []).slice(0, 3).map((s, i) => (
                                <span
                                  key={i}
                                  className="px-1 py-0.5 rounded bg-[rgba(255,255,255,0.04)] text-[rgba(255,255,255,0.5)] text-2xs border border-[rgba(255,255,255,0.1)]"
                                >
                                  {s}
                                </span>
                              ))}
                              {(r.signals ?? []).length > 3 && (
                                <span className="text-[rgba(255,255,255,0.3)]">+{r.signals.length - 3}</span>
                              )}
                            </div>
                          </td>
                        </tr>
