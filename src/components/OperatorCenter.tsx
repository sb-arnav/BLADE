...
function capabilityTone(category: string) {
  switch (category) {
    ...
    case "self-upgrade":
      return "text-[#c8cbff] border-[#6366f1]/20 bg-blade-bg";
    case "security":
            ...
            <section className="rounded-2xl border border-blade-border bg-blade-surface p-4">
              <div className="flex items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="text-2xs px-3 py-1.5 rounded-lg bg-blade-bg text-[#c8cbff] border border-[#6366f1]/20"
                >
                  desktop quickstart
                </button>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3 mt-4">
                {runtimes.runtimes.length > 0 ? (
                  ...
                  <div className="md:col-span-2 rounded-xl border border-blade-border/60 bg-blade-bg px-4 py-5">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1.1fr,0.9fr] gap-4 mt-4">
                <div className="space-y-3">
                  <div>
                    ...
                    <textarea
                      ...
                      className="w-full rounded-xl bg-blade-bg border border-blade-border px-3 py-3 text-sm text-blade-text outline-none focus:border-[#6366f1]/40 resize-none"
                    />
                  </div>
                  ...
                  {handoffSourceTaskId ? (
                    <div className="rounded-xl border border-[#6366f1]/20 bg-blade-bg px-3 py-2 text-2xs text-[#c8cbff]">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full rounded-xl bg-blade-bg border border-blade-border px-3 py-2 text-xs text-blade-text outline-none focus:border-[#6366f1]/40"
                      />
                    </div>
                    <div>
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    <div className="rounded-xl border border-blade-border bg-blade-bg px-3 py-3">
                  ...
                  <div className="flex flex-wrap gap-2 pt-1">
                    <button
                      ...
                      disabled={!goal.trim()}
                      className="text-xs px-3 py-2 rounded-xl bg-blade-bg text-[#c8cbff] hover:text-white disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                    >
                      Design mission
                    </button>
                    <button
                  ...
                  {mission ? (
                    <label className="flex items-center gap-2 text-2xs text-blade-muted">
                      <input
                        ...
                        className="rounded border-blade-border bg-blade-bg"
                      />
                    ...
                    <div className="rounded-xl border border-blade-border bg-blade-bg px-3 py-3">
                      <div className="flex items-start justify-between gap-3">
                        ...
                        <button
                          ...
                          className="text-2xs px-2.5 py-1.5 rounded-lg bg-blade-bg text-[#c8cbff] hover:text-white disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                        >
                          Run mission
                        </button>
                      </div>
              ...
              <div className="rounded-2xl border border-blade-border bg-blade-surface p-4">
                <div className="mb-4">
                  <div className="mb-4">
                    ...
                    <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <input
                        ...
                        className="md:col-span-2 w-full rounded-xl bg-blade-bg border border-blade-border px-3 py-2 text-xs text-blade-text outline-none focus:border-[#6366f1]/40"
                      />
                    </div>
                    <div className="mt-3 flex flex-wrap gap-2">
                      <button
                        onClick={() => void handleSaveWebIntelligence()}
                        className="text-2xs px-3 py-1.5 rounded-lg bg-blade-bg text-[#c8cbff] hover:text-white transition-colors"
                      >
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mt-3 space-y-2 max-h-[15rem] overflow-y-auto">
                      {runtimes.capabilityBlueprints.map((blueprint) => (
                        <div
                          key={blueprint.id}
                          className="rounded-lg border border-blade-border/60 bg-blade-bg px-3 py-2"
                        >
                          <div className="flex items-start justify-between gap-3">
                            <div>
                          ...
                          <div className="mt-2 flex flex-wrap gap-2">
                            <button
                              ...
                              className="text-2xs px-2.5 py-1 rounded-lg bg-blade-bg text-[#c8cbff] hover:text-white transition-colors"
                            >
                              Load into mission
                            </button>
                            <button
                  ...
                  <div className="mb-4">
                    ...
                    {runtimes.pluginCommands.length > 0 ? (
                      <div className="mt-3 rounded-lg border border-blade-border/60 bg-blade-bg px-3 py-2">
                  ...
                  <div className="mb-4">
                    ...
                    <div className="mt-3 grid grid-cols-1 md:grid-cols-2 gap-3">
                      ...
                      <textarea
                        ...
                        className="md:col-span-2 w-full rounded-xl bg-blade-bg border border-blade-border px-3 py-3 text-xs text-blade-text outline-none focus:border-[#6366f1]/40 resize-none"
                      />
                      <select
                    ...
                    {runtimes.missions.length > 0 ? (
                      runtimes.missions.slice(0, 8).map((stored) => (
                        <button
                          ...
                          className="w-full text-left rounded-lg border border-blade-border/60 bg-blade-bg px-3 py-2 hover:border-blade-accent/20 transition-colors"
                        >
                ...
                <div className="mt-4 space-y-2 max-h-[24rem] overflow-y-auto">
                  {resumableSessions.length > 0 ? (
                    ...
                    <div className="rounded-lg border border-blade-border/60 bg-blade-bg px-3 py-4">
                ...
                <div className="mt-4 space-y-3 max-h-[24rem] overflow-y-auto">
                  {runtimes.tasks.length > 0 ? (
                    runtimes.tasks.map((task) => {
                      ...
                      return (
                        <div key={task.id} className="rounded-xl border border-blade-border/60 bg-blade-bg p-3">
                          <div className="flex items-start justify-between gap-3">
                            <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                ...
                                className="text-2xs px-2 py-1 rounded-md bg-blade-bg text-[#c8cbff] hover:text-white transition-colors"
                              >
                                handoff
                              </button>
                            </div>
            ...
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex items-center gap-1.5">
                ...
                <button
                  ...
                  className="text-2xs px-2 py-1 rounded-md bg-blade-bg text-[#c8cbff] hover:text-white disabled:opacity-40 disabled:cursor-not-allowed transition-colors"
                >
                  run
                </button>
              </div>
