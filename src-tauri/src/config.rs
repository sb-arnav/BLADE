...
mod tests {
    ...
    fn reward_weights_round_trip() {
        ...
        let disk = DiskConfig {
            ...
            notification_listener_enabled: cfg.notification_listener_enabled,
            terminal_watch_enabled: cfg.terminal_watch_enabled,
            filesystem_watch_enabled: cfg.filesystem_watch_enabled,
